...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Out-2024 às 22:21
...
(4, 'Felipe Leonardo', '0000-00-00', '(90)97776-2312', 'leona2gmail.com', 2147483647, 'Rua do Cão', '69', 'Felipe', 'Leonardo'),
(5, 'Juju do Piquici', '0000-00-00', '(00)97878-2424', 'AAAAAgmail.com', 909090, 'CHIGXONGA', '00', 'Chinaland', 'Petroleia/SP');
...
--
ALTER TABLE `emprestimos`
  MODIFY `CodEmprestimo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
